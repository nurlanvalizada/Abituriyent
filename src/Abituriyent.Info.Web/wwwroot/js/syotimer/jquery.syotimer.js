...
(function($){
    ...
    var lang = {
        ...
        aze: {
            second: ['sanİyə', 'sanİyə'],
            minute: ['dəqİqə', 'dəqİqə'],
            hour: ['saat', 'saat'],
            day: ['gün', 'gün']
        }
    };
    ...
    const defaults = {
        ...
        headTitle: 'Qalan vaxt', // текст над таймером (можно в HTML формате)
        footTitle: '', // текст под таймером (можно в HTML формате)
        afterDeadline: function(timerBlock){
            timerBlock.bodyBlock.html('<p style="font-size: 1.2em;">Sizin vaxtınız başa çatdı!</p>');
            $("#checkResult").trigger('click');
        }
    };
